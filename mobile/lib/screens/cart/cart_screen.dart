    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Item duplicated in cart!'),
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Failed to repeat: $e'),
                    ...
                    itemBuilder: (context, index) {
                      if (index < flattenedItems.length) {
                        ...
                        return _CartItemCard(
                          ...
                          framePriceCalculated:
                              itemMap['framePriceCalculated'] as double,
                              ...
                              children: [
                                if (cart.productDiscounts > 0)
                                  _buildDiscountDetailRow(
                                    'Product Discount',
                                    '-₹${cart.productDiscounts.toInt()}',
                                  ),
                                if (cart.bogoDiscount > 0)
                                  _buildDiscountDetailRow(
                                    'Buy 1 Get 1 Offer',
                                    '-₹${cart.bogoDiscount.toInt()}',
                                  ),
          ...
          children: [
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: addGoldMembership
                    ? AppColors.success
                    : AppColors.gold,
                foregroundColor: addGoldMembership
                    ? Colors.white
                    : Colors.black,
        ...
        content: Column(
          ...
          children: [
            ...
            _buildBenefitRow(
              '2',
              '10% Cashback',
              'Get 10% cashback credited to your EyeGlaze wallet on every single purchase.',
            ),
            const SizedBox(height: 12),
            _buildBenefitRow(
              '3',
              'Free Shipping & Fitting',
              'No delivery charges, no fitting fees. Standard shipping is always on us.',
            ),
          ],
        ),
        actions: [
                  ...
                  Container(
                    ...
                    child:
                        cartItem.product != null &&
                            ((cartItem.product!.thumbnail != null &&
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (cartItem.lensConfig != null) ...[
                      if (cartItem.lensConfig!.name != null &&
                          cartItem.lensConfig!.name!.isNotEmpty) ...[
                        const SizedBox(height: 4),
                        Row(
                          children: [
                            const Text(
                      ...
                      if (cartItem.lensConfig!.uploadLater == true) ...[
                        const SizedBox(height: 4),
                        Text(
                          cartItem.lensConfig!.uploadedFileUrl != null
                              ? 'Prescription: 📄 Document Uploaded'
                              : 'Prescription: ⏳ Upload Later',
                          style: const TextStyle(
                            color: Colors.green,
                            fontSize: 10,
                            fontWeight: FontWeight.bold,
                      ...
                      ] else if (cartItem.lensConfig!.re != null ||
                          cartItem.lensConfig!.le != null) ...[
                        const SizedBox(height: 4),
                        Text(
                          'Power: '
              ...
              Column(
                ...
                children: [
                  Text(
                    isFree
                        ? 'Free'
                        : '₹${(framePriceCalculated + (cartItem.lensPrice ?? 0.0)).toInt()}',
                    style: TextStyle(
