...
async function main() {
  ...
  console.log(`FOUND ${orders.length} ORDERS FOR NAGA:`);
  orders.forEach(o => {
    console.log(`- Order ${o.orderId}: status=${o.status}, paymentStatus=${o.paymentStatus}, bogoApplied=${o.bogoApplied}, total=${o.total}, itemsCount=${o.items.length}`);
